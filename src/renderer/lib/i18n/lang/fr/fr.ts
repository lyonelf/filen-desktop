const fr: {
    ...
    change: "Modifier",
    open: "Ouvrir",
    noFilesOrFoldersUploadedYet: "Aucun fichier ou dossier importé pour l'instant",
    ...
    maximumUploadBandwidth: "Bande passante maximale d'importation (en Kbps)",
