const fr: {
    ...
    loginInvalidFields: "Champs non valides",
    loginInvalidEmail: "Adresse e-mail non valide",
    loginInvalidEmailOrPassword: "Adresse e-mail ou mot de passe non valide",
    ...
    change: "Modifier",
    open: "Ouvrir",
    noFilesOrFoldersUploadedYet: "Aucun fichier ou dossier chargé",
    ...
    clear: "Effacer",
    uploadBandwidthThrottling: "Limitation de bande passante de chargement",
    unlimited: "Illimité",
    downloadBandwidthThrottling: "Limitation de bande passante de téléchargement",
    ...
    syncModeLocalBackupInfo: "Importe seulement les données dans le cloud, ne supprime jamais rien ni ne prend en compte les changements distants",
